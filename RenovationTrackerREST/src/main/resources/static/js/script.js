...
function displayProject(project) {
	...
	while (findAllData.firstElementChild) {
		dataDiv.removeElement(findAllData.firstElementChild);
	}
	...
	dataDiv.appendChild(projectInfo);
...
function displayAllProjects(projects) {
		...
		projectUpdateForm(project); */ 
			...
			document.getElementById('updateForm').submit.addEventListener('click', updateProject);
